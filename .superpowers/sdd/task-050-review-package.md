...
cf64784 test: provide dates for invalid prediction horizons
453a70d feat: add minimal prediction domain contracts

## 统计

 .superpowers/sdd/task-050-report.md      |  24 ++
 src/stock_agent/domain/market_rules.py   |   5 +
 src/stock_agent/domain/prediction.py     | 436 +++++++++++++++++++++++++++++++
 tests/property/test_prediction_labels.py |   6 +
 4 files changed, 471 insertions(+)

## 差异

```diff
diff --git a/.superpowers/sdd/task-050-report.md b/.superpowers/sdd/task-050-report.md
new file mode 100644
index 0000000..d93f77d
--- /dev/null
+++ b/.superpowers/sdd/task-050-report.md
@@ -0,0 +1,24 @@
+# T050 预测领域实现报告
+
+## 完成内容
...
diff --git a/src/stock_agent/domain/prediction.py b/src/stock_agent/domain/prediction.py
new file mode 100644
index 0000000..156fcf0
--- /dev/null
+++ b/src/stock_agent/domain/prediction.py
@@ -0,0 +1,436 @@
...
index a1303b7..f396262 100644
--- a/tests/property/test_prediction_labels.py
+++ b/tests/property/test_prediction_labels.py
@@ -50,20 +50,26 @@ from stock_agent.domain.market_rules import CompanyAction, TradingCalendar
     date(2026, 7, 21),
     date(2026, 7, 22),
     date(2026, 7, 23),
     date(2026, 7, 24),
